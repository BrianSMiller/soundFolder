function [audio, weighting, fileInfo, startSample, endSample] = downsampleAudioFromFiles(fileInfo,startTime,endTime,channel,newRate,exclusions)
...
if nargin < 6 || isempty(exclusions)
